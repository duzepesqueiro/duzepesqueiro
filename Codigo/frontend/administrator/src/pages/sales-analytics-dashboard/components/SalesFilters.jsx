...
const SalesFilters = ({ onFiltersChange, className = '' }) => {
    ...
    <div className={`bg-card border border-border rounded-lg ${className}`}>
      ...
      <div className="p-4 border-b border-border">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="font-semibold text-foreground">Filtro de Vendas</h3>
      ...
      {isExpanded && (
        <div className="p-4 space-y-6">
          {/* Product Categories */}
          <div>
            <h4 className="font-medium text-foreground mb-3">Categorias dos Produtos</h4>
          ...
          {/* Customer Segments */}
          <div>
            <h4 className="font-medium text-foreground mb-3">Perfis de Clientes</h4>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {filters?.salesRep?.length > 0 && (
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-secondary text-secondary-foreground text-sm">
                ...
                {filters?.salesRep?.length} Representante de Vendas{filters?.salesRep?.length > 1 ? 's' : ''}
                <button
