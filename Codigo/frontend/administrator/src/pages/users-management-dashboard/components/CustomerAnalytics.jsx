  ...
  return (
    <div className={`bg-card border border-border rounded-lg ${className}`}>
      ...
      <div className="p-6">
        ...
        {activeTab === 'behavior' && (
          <div>
            <h4 className="font-medium text-foreground mb-4">Padrões de Comportamento de Compra</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-muted rounded-lg">
                ...
                <div className="font-semibold text-foreground">Horário de Maior Movimentação</div>
              ...
              <div className="text-center p-4 bg-muted rounded-lg">
                ...
                <div className="font-semibold text-foreground">Valor Médio de Cesta de Compras</div>
                <div className="text-sm text-muted-foreground">$45.60</div>
              </div>
              <div className="text-center p-4 bg-muted rounded-lg">
                <Icon name="Repeat" size={24} className="text-accent mx-auto mb-2" />
                <div className="font-semibold text-foreground">Taxa de Retorno</div>
        ...
        {activeTab === 'retention' && (
          <div>
            <h4 className="font-medium text-foreground mb-4">Customer Retention Analysis</h4>
            ...
            <div className="bg-muted rounded-lg p-4">
              <h5 className="font-medium text-foreground mb-3">Coorte de Retenção (Últimos 6 Meses)</h5>
