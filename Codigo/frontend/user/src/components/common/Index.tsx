...
import { ChevronDown, ChevronLeft, ShieldCheck, Trees, Building2, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[90vh] min-h-[620px] flex items-center justify-center overflow-hidden">
        ...
        <div className={styles.heroOverlay} />
                <div className="absolute top-24 left-4 z-30 flex items-center gap-3 md:left-6">
          <Link
            to="/"
            className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/85 px-4 py-2 text-sm font-semibold text-slate-800 shadow-lg backdrop-blur-md transition hover:-translate-y-0.5 hover:bg-white"
          >
            ...
            <div className="relative grid gap-12 lg:grid-cols-[0.95fr_1.15fr] lg:items-center">
              ...
              >
                ...
                <div className="space-y-4">
                  <h2 className="font-display text-3xl md:text-4xl font-bold text-white leading-tight">
                    Conforto simples para uma estadia sem complicacao
                  </h2>
                  <p className="max-w-xl text-white/75 leading-relaxed">
                    Escolha as datas, veja os quartos disponiveis e finalize sua reserva de forma direta. A area de hospedagem foi pensada para ser clara, bonita e facil de usar.
                  </p>
                </div>
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  {[
                    ...
                    },
                    {
                      ...
                      desc: 'Natureza e conforto no mesmo espaco.',
                    },
                    {
              ...
              >
                ...
                <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.65)]">
                  <img
                    src={roomSuite}
                    alt="Hospedagem Du Ze Pesqueiro"
