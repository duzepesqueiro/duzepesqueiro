...
const RoomCard = ({ room, index, unavailable = false, onSelect }: RoomCardProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-sm transition-[box-shadow,border-color,transform] duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background',
        unavailable
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        <div className="flex items-start justify-between gap-3">
          <h3 className="min-h-12 font-display text-lg font-semibold leading-snug text-foreground line-clamp-2">
            {room.name}
          </h3>
        ...
        <div className="mb-4 mt-2 flex min-h-6 flex-wrap items-center gap-x-2 gap-y-1 text-muted-foreground">
        ...
        <p className="mb-4 min-h-10 line-clamp-2 text-sm text-muted-foreground">{room.description}</p>
        ...
        <div className="mt-auto flex flex-col items-stretch gap-3 border-t border-border pt-3">
          <div>
          ...
          <button
            type="button"
            className={cn(
              'min-h-11 w-full rounded-xl border px-4 py-2 text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background',
              unavailable
